...
import { isAmericanExpress, isLuhnsValid, validPayment, } from '../controllers/payment';
...
describe('POST /validate', () => {
    ...
    it('returns 400 if card is expired', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(app).post('/validate').send({
    ...
    it('returns 400 if CVV is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(app).post('/validate').send({
    ...
    it('returns 400 if card number is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(app).post('/validate').send({
            expiryDate: '2030-01-01',
            cvv: '123',
    ...
    it('returns 201 if payment is valid', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(app).post('/validate').send({
            expiryDate: '2030-01-01',
            cvv: '123',
            cardNumber: '4532015112830366',
